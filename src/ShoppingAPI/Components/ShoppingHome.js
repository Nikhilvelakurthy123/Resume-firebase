    ...
    return (
        <div className="container-fluid mb-4">
            ...
            <div className="col-12 ">
                <div className='d-flex flex-row flex-wrap mb-4 p-4' style={{ height: ' 600px ', overflow: 'auto' }}>
                    {
                        getAllProducts.map(data =>
                            <div className="card ms-2 me-2 mt-2" key={data.id} style={{ height: "350px", width: "200px" }}>
